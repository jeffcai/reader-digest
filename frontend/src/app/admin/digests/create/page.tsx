...
export default function CreateDigestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const endDate = new Date(formData.week_end);
      if (endDate <= startDate) {
        setError('Week end date must be after start date');
        return;
      }
      ...
      // Use digestsAPI for authenticated admin create
      await digestsAPI.createDigest(digestData);
      ...
      if (errorResponse.response?.status === 401) {
        ...
        setError(errorResponse.response?.data?.error || 'Failed to create digest');
      }
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Create New Digest</h1>
          <p className="text-gray-600 mt-1">
            Create a new weekly digest with markdown support
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <input
              ...
              placeholder="Enter digest title (e.g., 'Weekly AI Digest - December 2024')"
              required
            />
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Default dates are set to current week. Adjust as needed.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <textarea
              ...
              onChange={handleInputChange}
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              placeholder="Add a brief summary of your digest that will be shown in previews and search results..."
            />
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="mt-4 p-3 bg-gray-50 rounded-md">
              <p className="text-sm text-gray-600">
                <strong>Draft mode:</strong> Keep &quot;Publish&quot; unchecked to save as a draft for later editing.<br/>
                <strong>Published:</strong> Check &quot;Publish&quot; to make the digest live and visible to others (if public).
              </p>
            </div>
          </div>
